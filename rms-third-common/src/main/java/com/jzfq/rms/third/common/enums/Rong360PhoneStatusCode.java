 ...
 */
public enum Rong360PhoneStatusCode {
    ...
    private Rong360PhoneStatusCode(int code, String msg) {
        this.code = code;
        this.msg = msg;
    }
    ...
    static{
        for (Rong360PhoneStatusCode item : Rong360PhoneStatusCode.values()) {
