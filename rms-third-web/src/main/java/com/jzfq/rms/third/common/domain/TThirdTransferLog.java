...
public class TThirdTransferLog {
    private String cId;

    private String cThirdKey;
    ...
    public String getcThirdKey() {
        return cThirdKey;
    }

    public void setcThirdKey(String cThirdKey) {
        this.cThirdKey = cThirdKey == null ? null : cThirdKey.trim();
    }
