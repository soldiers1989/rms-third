package com.jzfq.rms.third.persistence.interceptor;

import com.jzfq.rms.third.common.utils.StringUtil;
import com.jzfq.rms.third.common.domain.PageParam;
    ...
    public Object intercept(Invocation invocation) throws Throwable
    {
       ...
       if (null != delegate) {
           ...
           if (page != null)
           {
               ...
               if (null != ReflectUtil.getFieldValue(delegate, "mappedStatement")) {
...
//        return "select count(*) from (" + sql + ") aliasForPage";
    ...
    {
        if (StringUtil.checkNotEmpty(str) && StringUtil.checkNotEmpty(key))
        {
            int c = 0;
            int b = -1;
