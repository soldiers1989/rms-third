 ...
 **/
public class Request1004 extends AbstractRequestAuthentication {
    public Request1004(String appId, String apiId, long timestamp, String token, String apiVersion) {
