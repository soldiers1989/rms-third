 ...
 **/
public class Request1005 extends AbstractRequestAuthentication {
    public Request1005(String appId, String apiId, long timestamp, String token, String apiVersion) {
