 ...
 **/
public class Request1006 extends AbstractRequestAuthentication {
    public Request1006(String appId, String apiId, long timestamp, String token, String apiVersion) {
