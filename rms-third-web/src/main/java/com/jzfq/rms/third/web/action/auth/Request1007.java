 ...
 **/
public class Request1007 extends AbstractRequestAuthentication {
    public Request1007(String appId, String apiId, long timestamp, String token, String apiVersion) {
