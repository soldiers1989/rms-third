 ...
 **/
public class Request1010 extends AbstractRequestAuthentication{
    public Request1010(String appId, String apiId, long timestamp, String token, String apiVersion) {
