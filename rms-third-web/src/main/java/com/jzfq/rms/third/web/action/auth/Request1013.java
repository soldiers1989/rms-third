 ...
 **/
public class Request1013 extends AbstractRequestAuthentication {
    public Request1013(String appId, String apiId, long timestamp, String token, String apiVersion) {
