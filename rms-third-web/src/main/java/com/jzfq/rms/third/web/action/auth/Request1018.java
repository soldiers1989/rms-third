 ...
 **/
public class Request1018 extends AbstractRequestAuthentication{
    public Request1018(String appId, String apiId, long timestamp, String token, String apiVersion) {
