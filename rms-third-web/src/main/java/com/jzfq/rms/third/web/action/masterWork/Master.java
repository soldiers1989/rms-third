...
public class Master {
    ...
    //1 应该有一个承装任务的集合
    private ConcurrentLinkedQueue<BrScoreModel> workQueue = new ConcurrentLinkedQueue<BrScoreModel>();
    ...
    //5 提交方法
    public void submit(BrScoreModel task){
    ...
    public int getResult() {
        ...
        for(Map.Entry<String, Object> me : resultMap.entrySet()){
            //汇总的逻辑..
            ret += Integer.parseInt(me.getValue().toString());
        }
        return ret;
    }
